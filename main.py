...
def main():
    ...
    # Input the value of k, which is the number of nodes to remove
    ...
    # Apply the greedy algorithm to remove the highest degree nodes
...
# Load the existing Excel file, remove comments when you want to load new data to excel file
# Determine rows, where to load data
    """try:
